      ...
      body: _isLoading
          ? const Center(
              child: Column(
                ...
                children: [
                  CircularProgressIndicator(color: Color(0xFF6D3EFF)),
                  SizedBox(height: 16),
                  Text(
                    'Cargando pedidos...',
                              ...
                              MaterialPageRoute(
                                builder: (_) => DetallePedidoScreen(
                                  ...
                                  onPedidoActualizado: (pedidoActualizado) {
                                    setState(() {
                                      final index = _localPedidos.indexWhere(
                                        (o) => o.id == pedidoActualizado.id,
                                      );
                                      if (index != -1) {
                                        _localPedidos[index] =
                                            pedidoActualizado;
                                    ...
                                    children: [
                                      Expanded(
                                        child: ElevatedButton(
                                          onPressed: () {
                                            print(
                                              '🔍 Navegando con pedidoId: ${pedido.id}',
                                            );
